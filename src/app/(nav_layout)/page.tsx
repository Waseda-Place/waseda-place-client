  ...
  return (
    <main className="flex w-full flex-col items-center">
      <div className="flex w-full max-w-5xl flex-col">
        <div className="flex w-full flex-col items-center space-y-8 p-8 sm:flex-row">
          <div className="flex flex-col items-center justify-center sm:w-2/5">
            <p className="text-4xl font-bold text-black">Waseda Place</p>
            <div className="h-2" />
            <p className="text-center text-2xl text-black">
              Where Rooms meet Minds
            </p>
            <div className="h-8" />
          ...
          <Image
            src="/waseda-place-main.png"
            alt="Waseda Place Main Image"
            width="0"
            height="0"
            sizes="100vw"
            className="h-auto w-full sm:w-3/5"
            priority
          />
        </div>
        <div className="bg-light-gray flex w-full px-24 py-16">
          <div className="flex flex-col">
            <p className="text-gray text-6xl font-light">About</p>
            <div className="h-8" />
            ...
            <div className="h-8" />
            <div className="inline-flex items-center bg-white p-4">
          ...
          <Image
            src="/waseda-place-about.png"
            alt="Waseda Place About Image"
            width="0"
            height="0"
            sizes="100vw"
            className="h-auto w-full sm:w-3/5"
